...
public:
    ...
    void particular_book()
    {
        ...
        {
            stu *temp = head;
            cout << "Book is issued to : " << endl;
            while (temp)
            {
                if (temp->issued1)
                {
                    if (temp->issued1->ref_no == book->ref_num)
                    {
                ...
                if (temp->issued2)
                {
                    if (temp->issued2->ref_no == book->ref_num)
                    {
                        cout << "Roll No. : " << temp->roll_no << endl;
                        cout << "Name : " << temp->name << endl
                             << endl;
